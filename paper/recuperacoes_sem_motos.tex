...
valor esperado do conjunto é de \textbf{\reais{186} mil} a preços de revenda (banda de 90\%:
\reais{163}--\reais{211} mil) e \textbf{\reais{312} mil} a preços de reposição
(\reais{271}--\reais{357} mil); o envelope extremo vai de \reais{44} mil a \reais{1{,}37} milhão.
Os celulares concentram cerca de 77\% do valor. Todas as cifras têm fonte pública (coleta em
16/06/2026).
\end{abstract}
...
(Caloi/Mormaii) e usados do Rio (OLX-RJ, Caloi $\approx$70\%), não bicicletas de sistema
compartilhado. Os cordões seguem a prevalência de folheado vs.\ ouro.

\subsection{Coleta de preços e distribuições empíricas}
Para cada modelo coletou-se uma \textbf{amostra de preços observados} (16/06/2026): 324
...
\begin{table}[H]
  ...
  \begin{tabular}{llrrr}
    ...
    Cordões    & revenda   & 1.977 & 2.621 & 75--5.777 \\
               & reposição & 3.933 & 4.911 & 49--14.019 \\
    \bottomrule
  \end{tabular}
...
contribuição por categoria: os \textbf{celulares} respondem por cerca de \textbf{77\%} do total.
...
\begin{table}[H]
  ...
  \begin{tabular}{lrrrr}
    ...
    \midrule
    Celulares  & 118 & 143.016 & 231.752 & 77,2\% \\
    Cordões    & 15  & 29.655  & 58.995  & 16,0\% \\
    Bicicletas & 19  & 12.692  & 21.185  & 6,8\% \\
    \midrule
    \textbf{Total} & — & \textbf{$\approx$185.363} & \textbf{$\approx$311.932} & 100\% \\
    \bottomrule
  \end{tabular}
...
(\reais{186}--\reais{312} mil) e pelo \textbf{envelope extremo} de \reais{44} mil (se cada item
fosse o modelo usado mais barato) a \reais{1{,}37} milhão (se cada item fosse o modelo novo mais
caro).

% =====================================================================
\section{Conclusões}
% =====================================================================
O patrimônio recuperado pela Força Municipal no período vale, em valor esperado, entre \reais{186}
mil (revenda) e \reais{312} mil (reposição), com envelope de \reais{44} mil a \reais{1{,}37}
milhão. O resultado é dominado pelos celulares ($\approx$77\%). O tratamento probabilístico mostra
