...
variar $f$. O caso-base da Tabela~\ref{tab:itens} ($\mathbb{E}[V_{\text{cord}}]=\reais{462}$ em
...
Total $V^{\text{rev}}$ & \reais{160} mil & \reais{163} mil & \reais{165} mil \\
\bottomrule
\end{tabular}
\end{center}
A conclusão é robusta: como os cordões são $\approx$4\% do patrimônio (Tabela~\ref{tab:contrib}), o
total varia cerca de 3\% mesmo dobrando $f$. As cifras de preço (folheado \reais{15}--\reais{250};
...
direita (massa em aparelhos de entrada, cauda nos \emph{flagships}); o cordão é o mais assimétrico
--- a massa fica no folheado de baixo valor, com cauda longa e fina nas peças de ouro (média bem
acima da mediana). A Tabela~\ref{tab:itens} resume os momentos.
...
\textbf{\reais{163} mil} a preços de revenda e \textbf{\reais{267} mil} a preços de reposição. A
Figura~\ref{fig:total} mostra as duas distribuições com suas bandas de 90\%
(\reais{145}--\reais{181} mil e \reais{237}--\reais{299} mil). A Tabela~\ref{tab:contrib} detalha a
